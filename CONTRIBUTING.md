# Contributing to jquery.equalheight
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/jquery.equalheight
   # Navigate to the newly cloned directory
   cd jquery.equalheight
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/bramsmulders/jquery.equalheight
   ```
